...
<p align="center">
  <img src="https://img.shields.io/github/stars/Ashwin18-Offcl/VS_Code_Portfolio?style=for-the-badge"/>
  <img src="https://img.shields.io/github/forks/Ashwin18-Offcl/VS_Code_Portfolio?style=for-the-badge"/>
  <img src="https://img.shields.io/github/issues/Ashwin18-Offcl/VS_Code_Portfolio?style=for-the-badge"/>
  <img src="https://img.shields.io/github/downloads/Ashwin18-Offcl/VS_Code_Portfolio/total?style=for-the-badge"/>
</p>
...
```mermaid
flowchart TB
    A[Project Requirement] --> B[Workspace Setup]
    B --> C[Extensions Configuration]
    C --> D[Code Development]
    D --> E[Debugging & Testing]
    E --> F[Version Control]
    F --> G[Optimization & Refactoring]
    G --> H[Final Output]

    classDef phase fill:#020617,color:#ffffff,stroke:#007ACC,stroke-width:2px
...
```mermaid
flowchart LR
    A[VS Code Basics]:::basic --> B[Editor Customization]:::basic
    B --> C[Extensions Ecosystem]:::intermediate
    C --> D[Debugging Tools]:::intermediate
    D --> E[Git Integration]:::advanced
    E --> F[Productivity Automation]:::advanced
    F --> G[Professional Workflows]:::deploy
...
<p align="center">
  <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://github.com/Ashwin18-Offcl/VS_Code_Portfolio">
    <img src="https://img.shields.io/badge/Share%20on-LinkedIn-blue?style=for-the-badge&logo=linkedin"/>
  </a>
  <a href="https://twitter.com/intent/tweet?url=https://github.com/Ashwin18-Offcl/VS_Code_Portfolio&text=Visual%20Studio%20Code%20Professional%20Portfolio">
    <img src="https://img.shields.io/badge/Share%20on-X-black?style=for-the-badge&logo=x"/>
  </a>
</p>
